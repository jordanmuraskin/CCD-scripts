    ...
    for fb in [0,1]:
        for t in ['cope', 'varcope']:
            ...
            for subj in subject_list:
                ...
                fname = '/home/jmuraskin/Projects/CCD/working_v1/feedback/feedback_run-%d/_subject_id_%s/modelestimate/mapflow/_modelestimate/results/%s%d.nii.gz' % (fbLoc,subj,t,i)
                x.append(fname)
            subjs = len(x)
            merger = Merge()
